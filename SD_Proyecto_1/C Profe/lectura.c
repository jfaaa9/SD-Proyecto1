...
/*
=== PENDIENTE ===
1.- Trabajar con memoria din�mica
2.- Considerar los border de las im�genes
3.- Definir la paralelizaci�n de los algoritmos
4.- Establecer un menu para la selecci�n de algoritmos y elementos estructurantes.
5.- Definir el c�lculo de los tiempos de ejecuci�n
*/
int main(void){
	FILE *arch,*sali;
...
// Proceso	- Erosion
	...
	fprintf(sali,"P5\n");
	fprintf(sali,"# Creado por Rodrigo Pavez. (2020)\n");
	fprintf(sali,"%d %d\n",colu,fila);
    fprintf(sali,"%d\n",gris);
	for(i=0; i<fila; i++){
		for(j=0; j<colu; j++)
